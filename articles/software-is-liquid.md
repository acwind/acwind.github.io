This started as a talk I gave internally to a group of technology leaders. I’ve adapted it here, stripping out the company-specfic material, because the core ideas apply well beyond any one organization.
...
That’s okay. Just be aware of where you are. It’s fine to be out ahead of the curve; you just have and always know when you’re there, because it’s a risky spot. You don’t want to be too far out.
...
Go back further. Most of us spent the early parts of our careers in agile flows. Before that, everybody did waterfall. Why? Were they just not as smart? No – they enough was operating under a different set of assertions. If you made a mistake writing C code, it was really difficult to unwind. You’d take months to refactor a mistake in your domain model that showed up in C code.
...
I used to have a very firm belief. When I saw a people leader – a director or a manager – in code, that was a warning sign. Almost always, when I saw a director or a manager in code, they were probably avoiding something harder that they were supposed to be doing. “Oh, you’re working on the actual software? I bet you have a personnel problem you’re not dealing with.”
...
What are you in that loop? I don’t enough – a product manager, I guess.

I’m doing this today on multiple projects at home – using agents to give each each other feedback. This speed and paradigm shift is foundational to how we have to adjust our thinking.
...
How long is something going going to take? I’d argue every paradigm you have for answering that question is broken now. The cost understanding is broken. The complexity understanding is broken. It’s all broken.
